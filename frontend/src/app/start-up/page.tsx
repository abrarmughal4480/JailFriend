  ...
  return (
    <div className={`min-h-screen transition-colors duration-200 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'
      ...
      <div className="max-w-7xl mx-auto px-0 py-0 flex items-center justify-center min-h-screen">
        <div className={`rounded-xl sm:rounded-2xl shadow-xl flex flex-col lg:flex-row w-full overflow-hidden transition-colors duration-200 ${isDarkMode ? 'bg-gray-800' : 'bg-white'
          }`}>
          {/* Left Panel */}
          ...
          <div className="flex-1 p-3 sm:p-4 md:p-6 lg:p-8">
            ...
            <div className="hidden lg:flex flex-wrap items-center justify-center gap-1 sm:gap-2 mb-4 sm:mb-6">
              {steps.map((s, i) => (
                <React.Fragment key={s}>
                  <button
                    className={`px-2 sm:px-4 py-1 rounded-full text-xs font-semibold transition-all duration-200 ${step === i
              ...
              <div className="flex flex-col items-center justify-center min-h-[350px] sm:min-h-[400px] lg:min-h-[320px]">
                ...
                <form className="w-full max-w-xs sm:max-w-sm md:max-w-md flex flex-col gap-2 sm:gap-3 p-4 px-2 sm:px-4">
                  <input
                    ...
                    className={`border rounded-lg px-3 sm:px-4 py-2 sm:py-3 w-full text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${isDarkMode
                  ...
                  <textarea
                    ...
                    rows={3}
                    className={`border rounded-lg px-3 sm:px-4 py-2 sm:py-3 w-full text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none ${isDarkMode
                        ? 'border-gray-600 bg-gray-700 text-white placeholder-gray-400'
                        : 'border-gray-300 bg-white text-gray-900 placeholder-gray-500'
                      }`}
                    value={bio}
            ...
            {step === 2 && (
              <div className="flex flex-col items-center justify-center min-h-[350px] sm:min-h-[400px] lg:min-h-[320px]">
                <div className={`mb-4 sm:mb-6 font-medium text-center text-sm sm:text-base px-2 sm:px-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'
                  }`}>
                  About Me
                </div>
                <form className="w-full max-w-xs sm:max-w-sm md:max-w-md flex flex-col gap-2 sm:gap-3 p-4 px-2 sm:px-4">
            ...
            {step === 3 && (
              <div className="flex flex-col items-center justify-center min-h-[350px] sm:min-h-[400px] lg:min-h-[320px]">
                ...
                <div className={`mb-2 sm:mb-3 text-xs sm:text-sm text-center px-2 sm:px-4 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'
                  }`}>
                ...
                <form className="w-full max-w-xs sm:max-w-sm md:max-w-md flex flex-col gap-2 sm:gap-3 p-4 px-2 sm:px-4">
                  ...
                  {expertiseTags.length > 0 && (
                    <div className="flex flex-wrap gap-2 mt-2">
                      {expertiseTags.map((tag, index) => (
                        <span
                          key={index}
                          className={`px-3 py-1 rounded-full text-xs sm:text-sm ${isDarkMode
                  ...
                  {expertiseTags.length >= 7 && (
                    <div className={`text-xs mt-1 text-center ${isDarkMode ? 'text-gray-400' : 'text-gray-500'
                      }`}>
                  ...
                  <div className="mt-2">
                    ...
                    {categoriesLoading ? (
                      ...
                      <select
                        ...
                        className={`border rounded-lg px-3 sm:px-4 py-2 sm:py-2.5 w-full text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${isDarkMode
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'].map((day) => (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-lg text-xs sm:text-sm font-medium transition-all duration-200 ${availableDays.includes(day)
                    ...
                    users.map((user: any, i) => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex flex-col items-center border rounded-lg p-1 sm:p-2 md:p-3 relative transition-all duration-200 hover:scale-105 active:scale-95 ${isSelected
                    ...
                    users.map((user: any, i) => {
                      ...
                      return (
                        <div
                          ...
                          className={`border rounded-lg p-3 sm:p-4 cursor-pointer relative transition-all duration-200 hover:shadow-lg ${isSelected
                              ? isDarkMode ? 'bg-blue-900 border-blue-500 ring-2 ring-blue-400' : 'bg-blue-50 border-blue-500 ring-2 ring-blue-200'
