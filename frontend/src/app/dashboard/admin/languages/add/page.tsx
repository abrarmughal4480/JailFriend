  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? "bg-gray-900" : "bg-gray-50"}`}>
      <div className="p-4 lg:p-6">
        {/* Header */}
        <div className="mb-6">
          <h1 className={`text-2xl lg:text-3xl font-bold ${textPrimary} mb-2`}>Add New Language & Key</h1>
          <div className={`text-sm ${textSecondary} flex items-center space-x-2`}>
            ...
            <span>Languages</span>
            <span>&gt;</span>
            <span className={isDarkMode ? "text-red-400" : "text-red-500"}>Add New Language & Key</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className={`${cardBase} rounded-xl p-6`}>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className={`text-xl font-semibold ${textPrimary}`}>Add New Language</h2>
            </div>

            {/* Info Notice */}
            <div className={`${isDarkMode ? "bg-blue-900/30 border-blue-800" : "bg-blue-50 border-blue-200"} border rounded-lg p-4 mb-6 flex items-start gap-3`}>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder=""
                />
                <p className={`text-xs ${textTertiary} mt-1`}>Use only english letters, no spaces allowed. E.g: russian</p>
              </div>
          ...
          <div className={`${cardBase} rounded-xl p-6`}>
            <div className="flex items-center gap-3 mb-6">
              <Key className={`w-6 h-6 ${isDarkMode ? "text-green-400" : "text-green-600"}`} />
              <h2 className={`text-xl font-semibold ${textPrimary}`}>Add New Language Key</h2>
            </div>
        ...
        <div className={`mt-8 ${cardBase} rounded-xl p-6`}>
          <h3 className={`text-lg font-semibold ${textPrimary} mb-4`}>Language Management Tips</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className={`font-medium ${textPrimary} mb-2`}>Adding Languages</h4>
            ...
            <div>
              <h4 className={`font-medium ${textPrimary} mb-2`}>Adding Language Keys</h4>
              <ul className={`text-sm ${textSecondary} space-y-1`}>
