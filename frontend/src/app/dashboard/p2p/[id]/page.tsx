          ...
          <div className={`mt-5 ${isDarkMode ? 'bg-gray-800' : 'bg-white'} rounded-[20px] p-5 shadow-lg border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
            ...
            <div className="mb-5">
              <div className="relative inline-flex rounded-lg bg-[#161616] p-1 border border-gray-600">
                <div
                  className={`absolute top-0 left-0 h-full w-1/2 rounded-lg bg-gradient-to-r from-[rgba(11,47,42,0.8)] to-[rgba(20,143,128,0.5)] transition-transform duration-300 ${
                    activeTab === 'services' ? 'translate-x-full' : ''
                  }`}
                />
                <button
                  onClick={() => setActiveTab('shorts')}
                  className={`relative z-10 px-4 py-2 flex items-center gap-2 rounded-lg transition-colors ${
                    activeTab === 'shorts' ? 'text-white' : 'text-gray-500'
                  }`}
                >
                ...
                <button
                  ...
                  className={`relative z-10 px-4 py-2 flex items-center gap-2 rounded-lg transition-colors ${
                    activeTab === 'services' ? 'text-white' : 'text-gray-500'
                  }`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
