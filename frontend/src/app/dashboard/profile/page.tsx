  ...
  const fetchUserProfile = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Redirect to the dynamic profile page using the user's ID
        // This ensures the user sees the modern layout shown in the screenshot
        router.push(`/dashboard/profile/${userData.id || userData._id}`);
      } else {
        console.error('Failed to fetch user profile for redirect:', response.status);
        setLoading(false);
      }
    } catch (error) {
          ...
          <div className="flex flex-col items-center gap-4 mb-6">
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center gap-3 flex-wrap">
                <button className={`px-4 py-2 rounded-lg transition-colors flex items-center gap-2 ${isDarkMode
          ...
          <div className="flex overflow-x-auto scrollbar-hide">
            {tabs.map((tab) => (
              <button
                ...
                className={`flex items-center gap-2 py-4 px-6 border-b-2 transition-colors whitespace-nowrap min-w-fit ${activeTab === tab.id
              ...
              <div className="lg:col-span-1 space-y-6">
                ...
                <div className={`rounded-xl shadow-sm p-4 space-y-4 transition-colors duration-200 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className={`flex items-center justify-between p-4 rounded-lg border transition-colors ${isDarkMode
                    ...
                    <div className="filter-scroll flex items-center gap-3">
                      {filters.map((filter) => (
                        <button
                          ...
                          className={`flex items-center gap-2 px-4 py-2.5 rounded-lg transition-colors whitespace-nowrap ${activeFilter === filter.id
              ...
              <div>
                ...
                {albums.length > 0 ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {albums.map((album) => (
                      <div key={album._id} className={`rounded-lg p-5 border transition-colors duration-200 ${isDarkMode
                  ...
                  <div className="text-center py-12">
                    <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 transition-colors duration-200 ${isDarkMode ? 'bg-gray-700' : 'bg-gray-100'
                      }`}>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 p-4 sm:p-6 bg-black bg-opacity-50">
          <div className={`rounded-lg shadow-xl max-w-md w-full p-6 sm:p-8 max-h-[90vh] overflow-y-auto transition-colors duration-200 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
            ...
            <textarea
              ...
              className={`w-full h-32 p-4 border rounded-lg resize-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-base transition-colors duration-200 ${isDarkMode
            ...
            <div className="flex space-x-3 mt-6">
              <button
                ...
                className={`flex-1 px-4 py-2.5 border rounded-lg transition-colors text-base ${isDarkMode
